...
public class MyProgressView extends View {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            stationaryCircleColor = typedArray.getColor(R.styleable.MyProgressView_stationary_circle_color, Color.parseColor(CIRCLE_COLOR));
            fadingCircleColor = typedArray.getColor(R.styleable.MyProgressView_fading_circle_color, Color.parseColor(CIRCLE_COLOR));
            oribitingCircleColor = typedArray.getColor(R.styleable.MyProgressView_orbiting_circle_color, Color.parseColor(CIRCLE_COLOR));
            roationDirection = typedArray.getInt(R.styleable.MyProgressView_direction, 0);
            rStationary = typedArray.getDimension(R.styleable.MyProgressView_stationary_circle_radius, 12f);
            float orbitingCircleRadius = typedArray.getDimension(R.styleable.MyProgressView_orbiting_circle_radius, 6f);
    ...
    private class RefreshViewRunnable implements Runnable {
        ...
        public void run() {
            ...
            synchronized (MyProgressView.this) {
